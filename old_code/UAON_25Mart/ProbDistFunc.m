function [ output_args ] = BoxPlotFunc( filename,ylabeltext,outputfilename,stepnum)
%these will be given as parameters
%example is below
%filename='success_rates.txt';ylabeltext='Success Rates';outputfilename='PDFSR',stepnum=10;
%stepnum should be given separately 
%for message delays they are doubles/integers it should be 20
%for success rates they are numbers between 0 to 1 it should be 1
